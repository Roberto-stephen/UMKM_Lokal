-- Fixed SQL - Urutan tabel diperbaiki & foreign key duplikat dihapus
-- Original: HoussamMrabet/Simple-eCommerce-WebSite
...
-- --------------------------------------------------------
-- 1. Tabel `users` (harus pertama, dirujuk oleh items & comments)
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- 2. Tabel `categories` (harus sebelum items)
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- 3. Tabel `items` (butuh users & categories)
-- --------------------------------------------------------
...
-- --------------------------------------------------------
-- 4. Tabel `comments` (paling terakhir, butuh users & items)
-- --------------------------------------------------------
